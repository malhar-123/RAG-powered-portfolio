...
Achieved R² 0.687 and RMSE 7.50 on held-out race data.
...
GitHub: https://github.com/malhar-123/f1-race-prediction""",
    ...
    """Project: Predictive Credit Limit & Risk Segmentation (Financial ML).
...
GitHub: https://github.com/malhar-123/fmcg-demand-forecasting""",
    ...
    """Project: Environmental Analytics & Visualization (Data Visualization).
...
Machine Learning & AI: PyTorch, Scikit-learn, LightGBM, XGBoost, RAG pipelines,
...
Analytics & BI: Power BI, Tableau, SQL, DAX, Excel, VBA.
Mobile: Flutter, Dart.
Languages: Python, R, SQL, Dart, JavaScript.""",

    # ── LEADERSHIP ────────────────────────────────────────────────────────────
    """Malhar's leadership and campus roles:
Project Manager at StarDis at Illinois (Aug 2025–Present): Led a cross-functional
...
Student Career Navigator at UIUC Career Center (Aug 2025–Present): Analyzed
...
Data Quality & Accessibility Assistant at University of Illinois System
(Jun 2025–Present, Remote): Standardized 50+ institutional documents.
Validated screen-reader compatibility through manual QA.

Team Lead at National Service Scheme (Jun 2020–Jun 2022, India): Led community
